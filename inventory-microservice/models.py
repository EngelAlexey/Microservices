...
class BcItemLn(Base):
    ...
    lnPresentation = Column(String(150))
    lnQuality = Column(String(100))
    UnitID = Column(String(45))
    inCertification = Column(String(45))
    lnWeight = Column(Text)
    lnDeparture = Column(DECIMAL(13, 2), default=0)
...
class IcMovement(Base):
    ...
    mvUnitCost = Column(DECIMAL(13, 2), nullable=True)
    mvTax = Column(DECIMAL(13, 2), nullable=True)
    mvTotalCost = Column(DECIMAL(13, 2), nullable=True)
